...
{\href{https://www.idies.jhu.edu/what-we-offer/funding/idies-summer-student-fellowship/}{IDIES Summer Student Fellowship}} % parameter 2
{\textit{$\$$6,000, JHU, competitive research fellowship awarded to 5 undergraduates conducting data-intensive research.}}
\awardsentry{2024}  % parameter 1
{\href{https://www.sigmapisigma.org/sigmapisigma}{$\Sigma\Pi\Sigma$ Physics Honor Society}} % parameter 2
...
{\textit{$\$$6,000, JHU, competitive research fellowship (36 out of 400+ applicants).}} % parameter 3

\awardsentry{2023}  % parameter 1
{\href{https://krieger.jhu.edu/ursca/projects/aspire-grant/}{Dean's ASPIRE Grants}} % parameter 2
{\textit{$\$$2,474, JHU, competitive research fellowship; awarded to 10 undergraduates per year.}} % parameter 3
...
\begin{tabular}{L{4cm}@{\hskip 0.3in}L{13cm}} % Start a table with two columns, the table will ensure everything is aligned
	...
	\educationentry{Computer Slangs} % Duration
	{Python, C/C++, Java, Assembly, Fortran, Matlab, R, HTML, CSS, JavaScript, Bash} % Department
	{} %Honours
	{} % Institution
	{}
 {}
	...
	{DS9, Siril, MESA (stellar structure), Rebound (N-body), Mercury (N-body)} % Degree
	{} % Department
	{} %Honours
	{} % Institution
	{}
	...
	%------------------------------------------------
 	...
 	\educationentry{Observation Qualifications} % Duration
	...
	{Pytorch, \LaTeX, Git, Slurm, Mathematica, JupyterLab, Adobe Lightroom, Adobe Photoshop, Blender, Soccer, A Cappella, Marathon} % Degree
	{} % Department
	{} %Honours
	{} % Institution
	{}
