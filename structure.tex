...
\newcommand{\collge}[6]{
    ...
    \expandafter\ifstrequal\expandafter{#5}{}{}{& #5\\} % Minor (optional)
    \expandafter\ifstrequal\expandafter{#6}{}{}{& #6\\} 
    % \ifthenelse{\equal{#6}{}}{}{& #6\\[6pt]} % grad courses (optional)
}
...
\newcommand{\telescope}[4]{
	\textsc{#1} & % Cycle
	\expandafter\ifstrequal\expandafter{#2}{}{}{{\raggedright\textbf{#2}}\\[2pt]} %  Telescope
 \expandafter\ifstrequal\expandafter{#3}{}{}{& {\textit{#3}}\\} % Proposal Title
  \expandafter\ifstrequal\expandafter{#4}{}{}{& {#4}\\} % PIs
}
